...
namespace LibroVirtual.Controllers
{
    public class ProfesoresController : Controller
    {
        ...
        public ProfesoresController(LibroVirtualContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Rut,Nombre,Especialidad,Telefono,Email,NombreUsuario,Contrasena")] Profesor profesor)
        {
            if (id != profesor.Id)
            {
                return NotFound();
