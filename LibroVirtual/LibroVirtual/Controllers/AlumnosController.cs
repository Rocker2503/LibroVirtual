...
namespace LibroVirtual.Controllers
{
    public class AlumnosController : Controller
    {
        ...
        public AlumnosController(LibroVirtualContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ApellidoPaterno,ApellidoMaterno,Nombres,Rut,Sexo,FechaNacimiento,Direccion,Comuna,Procedencia,EnObservacion")] Alumno alumno)
        {
            if (id != alumno.Id)
            {
                return NotFound();
